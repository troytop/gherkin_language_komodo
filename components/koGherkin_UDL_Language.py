# Komodo Gherkin language service.

import logging
from koUDLLanguageBase import KoUDLLanguage


log = logging.getLogger("koGherkinLanguage")
#log.setLevel(logging.DEBUG)


def registerLanguage(registry):
    log.debug("Registering language Gherkin")
    registry.registerLanguage(KoGherkinLanguage())


class KoGherkinLanguage(KoUDLLanguage):
    name = "Gherkin"
    lexresLangName = "Gherkin"
    ...
    lang_from_udl_family = {'SSL': 'Gherkin'}
